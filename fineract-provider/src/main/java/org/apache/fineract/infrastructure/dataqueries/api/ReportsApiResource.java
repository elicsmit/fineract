...
public class ReportsApiResource {
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Create a Report", operationId = "createReport", tags = {"Reports"}, description = "")
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Report", operationId = "updateReport", tags = {"Reports"}, description = "Only the useReport description can be updated for core reports.")
    ...
    @Path("{id}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Report", operationId = "deleteReport", tags = {"Reports"}, description = "Only non-core reports can be deleted.")
