...
public class ReportMailingJobApiResource {
    ...
    @Operation(summary = "Create a Report Mailing Job", operationId = "createReportMailingJob", tags = {"Report Mailing Jobs"}, description = "Mandatory Fields: "
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Report Mailing Job\n", operationId = "updateReportMailingJob", tags = {"Report Mailing Jobs"}, description = "")
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Report Mailing Job", operationId = "deleteReportMailingJob", tags = {"Report Mailing Jobs"}, description = "")
