...
public class RunreportsApiResource {
    ...
    @Operation(summary = "Return all available export types for the specific report", operationId = "retrieveAllAvailableExports", tags = {"Run Reports"}, description = "Returns the list of all available export types for a given report.")
    ...
    @Operation(summary = "Run a predefined report", operationId = "runReport", tags = {"Run Reports"}, description = ReportParameters.FULL_DESCRIPTION)
