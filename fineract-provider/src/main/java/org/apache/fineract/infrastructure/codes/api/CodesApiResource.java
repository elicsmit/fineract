...
public class CodesApiResource {
    ...
    @Operation(summary = "Retrieve Codes", tags = {"Codes"}, description = "Returns the list of codes.\n" + "\n" + "Example Requests:\n" + "\n" + "codes")
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Create a Code", tags = {"Codes"}, description = "Creates a code. Codes created through api are always 'user defined' and so system defined is marked as false.")
    ...
    @Path("{codeId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Code", tags = {"Codes"}, description = "Deletes a code if it is not system defined.")
