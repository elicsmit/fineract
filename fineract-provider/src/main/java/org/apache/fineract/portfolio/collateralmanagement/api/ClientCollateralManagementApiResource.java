...
public class ClientCollateralManagementApiResource {
    ...
    @Operation(summary = "Get Clients Collateral Products", operationId = "getClientCollateralProducts", tags = {"Client Collateral Management"}, description = "Get Collateral Product of a Client")
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Get Client Collateral Data", operationId = "getClientCollateralData", tags = {"Client Collateral Management"}, description = "Get Client Collateral Data")
    ...
    @Path("template")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Get Client Collateral Template", operationId = "getClientCollateralTemplate", tags = {"Client Collateral Management"}, description = "Get Client Collateral Template")
    ...
    @Operation(summary = "Add New Collateral For a Client", operationId = "addClientCollateral", tags = {"Client Collateral Management"}, description = "Add New Collateral For a Client")
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Consumes({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update New Collateral of a Client", operationId = "updateClientCollateral", tags = {"Client Collateral Management"}, description = "Update New Collateral of a Client")
    ...
    @Path("{collateralId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete Client Collateral", operationId = "deleteClientCollateral", tags = {"Client Collateral Management"}, description = "Delete Client Collateral")
