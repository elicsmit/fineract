...
public class SavingsProductsApiResource {
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Savings Product", operationId = "updateSavingsProduct", tags = {"Savings Product"}, description = "Updates a Savings Product")
    ...
    @Path("{productId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Savings Product", operationId = "deleteSavingsProduct", tags = {"Savings Product"}, description = "Deletes a Savings Product")
