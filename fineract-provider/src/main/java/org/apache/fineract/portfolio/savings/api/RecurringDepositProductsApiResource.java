...
public class RecurringDepositProductsApiResource {
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Recurring Deposit Product", operationId = "updateRecurringDepositProduct", tags = {"Recurring Deposit Product"}, description = "Updates a Recurring Deposit Product")
    ...
    @Path("template")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Recurring Deposit Product Template", tags = {"Recurring Deposit Product"}, operationId = "retrieveTemplateRecurringDepositProduct")
    ...
    @Path("{productId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Recurring Deposit Product", operationId = "deleteRecurringDepositProduct", tags = {"Recurring Deposit Product"}, description = "Deletes a Recurring Deposit Product")
    @ApiResponses({
