...
public class ClientTransactionsApiResource {
    ...
    @Operation(summary = "List Client Transactions", operationId = "retrieveAllClientTransactions", tags = {"Client Transaction"}, description = "The list capability of client transaction can support pagination."
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Undo a Client Transaction", operationId = "undoClientTransaction", tags = {"Client Transaction"}, description = "Undoes a Client Transaction")
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "List Client Transactions", operationId = "retrieveAllClientTransactionsByClientExternalId", tags = {"Client Transaction"}, description = "The list capability of client transaction can support pagination."
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Undo a Client Transaction", operationId = "undoClientTransactionByClientExternalId", tags = {"Client Transaction"}, description = "Undoes a Client Transaction")
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ClientTransactionsApiResourceSwagger.PostClientsClientIdTransactionsTransactionIdResponse.class)))
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Undo a Client Transaction", operationId = "undoClientTransactionByTransactionExternalId", tags = {"Client Transaction"}, description = "Undoes a Client Transaction")
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ClientTransactionsApiResourceSwagger.PostClientsClientIdTransactionsTransactionIdResponse.class)))
    public String undoClientTransaction(@PathParam("clientId") @Parameter(description = "clientId") final Long clientId,
            @PathParam("transactionExternalId") @Parameter(description = "transactionExternalId") final String transactionExternalId,
            @QueryParam("command") @Parameter(description = "command") final String commandParam,
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Undo a Client Transaction", operationId = "undoClientTransactionByClientAndTransactionExternalId", tags = {"Client Transaction"}, description = "Undoes a Client Transaction")
    @ApiResponse(responseCode = "200", description = "OK", content = @Content(schema = @Schema(implementation = ClientTransactionsApiResourceSwagger.PostClientsClientIdTransactionsTransactionIdResponse.class)))
    public String undoClientTransaction(
            @PathParam("clientExternalId") @Parameter(description = "clientExternalId") final String clientExternalId,
            @PathParam("transactionExternalId") @Parameter(description = "transactionExternalId") final String transactionExternalId,
