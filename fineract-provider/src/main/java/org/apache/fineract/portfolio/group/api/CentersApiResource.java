...
public class CentersApiResource {
    ...
    @Operation(summary = "Retrieve a Center Template", operationId = "retrieveTemplateCenter", tags = {"Centers"}, description = """
    ...
    @GET
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "List Centers", operationId = "retrieveAllCenters", tags = {"Centers"}, description = """
    ...
    @Path("{centerId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve a Center", operationId = "retrieveOneCenter", tags = {"Centers"}, description = """
            Retrieves a Center
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Create a Center", operationId = "createCenter", tags = {"Centers"}, description = """
            Creates a Center
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Center", operationId = "updateCenter", tags = {"Centers"}, description = "Updates a Center")
    ...
    @Path("{centerId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Center", operationId = "deleteCenter", tags = {"Centers"}, description = "A Center can be deleted if it is in pending state and has no association - groups, loans or savings")
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(tags = {"Centers"}, summary = "Activate a Center | Generate Collection Sheet | Save Collection Sheet | Close a Center | Associate Groups | Disassociate Groups", operationId = "handleCommandsCenter", description = """
            Activate a Center:
    ...
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Center accounts overview", operationId = "retrieveGroupAccountsCenter", tags = {"Centers"}, description = """
    ...
    @Operation(summary = "Download Centers Bulk Template", tags = {"Centers"}, operationId = "getBulkTemplateCenter")
    ...
    @Operation(summary = "Upload Centers Bulk Template", tags = {"Centers"}, operationId = "postBulkTemplateCenter")
