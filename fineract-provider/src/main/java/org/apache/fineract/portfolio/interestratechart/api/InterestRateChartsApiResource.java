...
public class InterestRateChartsApiResource {
    ...
    @GET
    @Path("template")
    @Operation(summary = "Retrieve Chart Details Template", operationId = "retrieveTemplateInterestRateChart", tags = {"Interest Rate Chart"}, description = """
    ...
    @GET
    @Operation(summary = "Retrieve all Charts", operationId = "retrieveAllInterestRateCharts", tags = {"Interest Rate Chart"}, description = """
    ...
    @Operation(summary = "Create a Chart", operationId = "createInterestRateChart", tags = {"Interest Rate Chart"}, description = "Creates a new chart which can be attached to a term deposit products (FD or RD).")
    ...
    @Path("{chartId}")
    @Consumes({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Chart", operationId = "updateInterestRateChart", tags = {"Interest Rate Chart"}, description = "It updates the chart")
    ...
    @DELETE
    @Path("{chartId}")
    @Operation(summary = "Delete a Chart", operationId = "deleteInterestRateChart", tags = {"Interest Rate Chart"}, description = "It deletes the chart")
