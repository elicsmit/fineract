...
public class HolidaysApiResource {
    ...
    @Operation(summary = "Create a Holiday", tags = {"Holidays"}, description = "Mandatory Fields: "
    ...
    @Path("{holidayId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve a Holiday", tags = {"Holidays"}, description = "Example Requests:\n" + "\n" + "holidays/1")
    ...
    @Consumes({ MediaType.APPLICATION_JSON })
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Update a Holiday", tags = {"Holidays"}, description = "If a holiday is in pending state (created and not activated) then all fields are allowed to modify. Once holidays become active only name and descriptions are allowed to modify.")
    ...
    @Path("{holidayId}")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Delete a Holiday", tags = {"Holidays"}, description = "This API allows to delete a holiday. This is a soft delete the deleted holiday status is marked as deleted.")
    ...
    @GET
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "List Holidays", tags = {"Holidays"}, description = "Example Requests:\n" + "\n" + "holidays?officeId=1")
    ...
    @Path("/template")
    @Produces({ MediaType.APPLICATION_JSON })
    @Operation(summary = "Retrieve Holiday Repayment Schedule Updation Type Options", description = "Returns the available options for updating repayment schedules during holidays.", tags = {"Holidays"})
