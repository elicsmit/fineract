...
public class PasswordPreferencesApiResource {
    ...
    @Operation(summary = "List Password Preferences", description = "Returns the password policies and their current status (active/inactive).", tags = {"Password preferences"})
